const assetList = {
    "register": {
        "images": [
            ...
            './svgs/registration/birds.svg',
            './svgs/registration/birds2.svg',
            './svgs/registration/field2.svg',
            './svgs/registration/leftarr.svg',
            './svgs/registration/list-tag.svg',
            './svgs/registration/loader.svg',
            './svgs/registration/rightarr.svg',
            './svgs/registration/scroll-bar.svg',
            './svgs/registration/scrollThumb.svg',
            './svgs/registration/scrollThumb2.svg',
            './svgs/registration/signin.svg',
            './svgs/registration/bg-extended2.svg',
            './svgs/registration/bg-extended3.svg',
            './svgs/registration/bg-extended4.svg',
            './svgs/registration/bg-extended8.svg',
            './svgs/registration/bg-mobile.svg',
            './svgs/registration/button-banner.svg',
            './svgs/registration/bg-extended.svg',
            './svgs/registration/bg-extended5.svg',
            './svgs/registration/reg-banner.svg',
            './svgs/registration/reg-banner2.svg',
        ],
        "videos": []
    },
    "contact": {
